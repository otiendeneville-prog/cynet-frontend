...
export default function FeedbackCard({ content, name, title, img }: FeedbackCardProps) {
  ...
  return (
    <div className="flex flex-col justify-between p-6 rounded-2xl bg-white shadow-sm border border-gray-100 max-w-[360px] min-h-[300px] h-full mx-auto text-left font-sans">
      ...
      <div className="flex flex-row items-center gap-0.5 mt-4 text-amber-400">
        {[...Array(5)].map((_, i) => (
      ...
      <div className="flex-1 flex flex-col justify-between mt-3">
        <p className="text-[14px] leading-relaxed text-gray-700 line-clamp-4">
          {content}
        </p>
        <button className="text-[13px] font-medium text-gray-400 text-left mt-3 hover:underline">
          Read more
        </button>
      </div>
